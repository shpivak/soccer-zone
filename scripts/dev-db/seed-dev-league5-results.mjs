...
const expectedScorers = [
  { name: 'הנרי גנגה', goals: 23 },
  { name: 'זיו אושבייב', goals: 12 },
  { name: "מואמן חאג' יחיא", goals: 11 },
  { name: 'מאמון שייח יוסף', goals: 9 },
  { name: 'מוחמד בראנסי', goals: 9 },
  { name: 'עדיאל אלון', goals: 9 },
  { name: 'דניאל וולסמן', goals: 8 },
  { name: 'יובל שלמה', goals: 8 },
  { name: 'טל עמוס', goals: 8 },
  { name: 'ודיע פדילה', goals: 8 },
  { name: 'מואמן נאסר', goals: 7 },
  { name: 'ליאור פרידמן', goals: 6 },
  { name: 'סעיד שיך יוסף', goals: 6 },
  { name: 'אסי סגל', goals: 6 },
  { name: "סירג' מסרואה", goals: 5 },
  { name: 'מתן עופר', goals: 4 },
  { name: 'עומאר אבו חיט', goals: 4 },
  { name: 'חוסיין נאסר', goals: 2 },
  { name: 'שי שמחיוב', goals: 2 },
...
const expectedAssisters = [
  { name: 'טל עמוס', assists: 11 },
  { name: 'יובל שלמה', assists: 8 },
  { name: 'הנרי גנגה', assists: 7 },
  { name: 'דניאל וולסמן', assists: 6 },
  { name: 'מוחמד בראנסי', assists: 6 },
  { name: 'שי שמחיוב', assists: 5 },
  { name: 'עומאר אבו חיט', assists: 5 },
  { name: 'ליאור פרידמן', assists: 5 },
  { name: 'חוסיין נאסר', assists: 4 },
  { name: 'מתן עופר', assists: 4 },
  { name: 'זיו אושבייב', assists: 4 },
  { name: 'ודיע פדילה', assists: 4 },
  { name: 'עדיאל אלון', assists: 4 },
  { name: "מואמן חאג' יחיא", assists: 4 },
  { name: 'סעיד שיך יוסף', assists: 4 },
  { name: 'אוס עבד אל רחים', assists: 3 },
  { name: 'מתן שגב', assists: 3 },
  { name: 'אסי סגל', assists: 3 },
  { name: 'מאמון שייח יוסף', assists: 3 },
  { name: "סירג' מסרואה", assists: 2 },
  { name: 'עבד אליהו', assists: 2 },
  { name: 'מואמן נאסר', assists: 2 },
...
const rosterBlueprint = {
  זאבים: [
    { name: 'הנרי גנגה', goals: 23, assists: 7 },
    { name: "מואמן חאג' יחיא", goals: 11, assists: 4 },
    { name: 'דניאל וולסמן', goals: 8, assists: 6 },
    { name: 'עומאר אבו חיט', goals: 4, assists: 5 },
    { name: 'חוסיין נאסר', goals: 2, assists: 4 },
    { name: 'מתן שגב', goals: 0, assists: 3 },
  ],
  אריות: [
    { name: 'זיו אושבייב', goals: 12, assists: 4 },
    { name: 'ודיע פדילה', goals: 8, assists: 4 },
    { name: 'אסי סגל', goals: 6, assists: 3 },
    { name: 'שי שמחיוב', goals: 2, assists: 5 },
    { name: 'עבד אליהו', goals: 1, assists: 2 },
    { name: 'הדר שפיבק', goals: 1, assists: 1 },
    { name: 'אוס עבד אל רחים', goals: 1, assists: 3 },
  ],
  דרקונים: [
    { name: 'עדיאל אלון', goals: 9, assists: 4 },
    { name: 'יובל שלמה', goals: 8, assists: 8 },
    { name: 'טל עמוס', goals: 8, assists: 11 },
    { name: "סירג' מסרואה", goals: 5, assists: 2 },
    { name: 'ליאור פרידמן', goals: 6, assists: 5 },
    { name: 'מתן עופר', goals: 4, assists: 4 },
    { name: 'בן גמליאל', goals: 1, assists: 0 },
  ],
  נשרים: [
    { name: 'מוחמד בראנסי', goals: 9, assists: 6 },
    { name: 'מאמון שייח יוסף', goals: 9, assists: 3 },
    { name: 'מואמן נאסר', goals: 7, assists: 2 },
    { name: 'סעיד שיך יוסף', goals: 6, assists: 4 },
...
const tournamentBlueprint = [
  ...
  { leagueNumber: 5, date: '2026-04-11' },
]
...
const matchBlueprint = [
  ...
  { leagueNumber: 5, round: 1, time: '20:00', teamA: 'דרקונים', teamB: 'נשרים', score: { a: 7, b: 6 } },
  { leagueNumber: 5, round: 2, time: '21:00', teamA: 'אריות', teamB: 'זאבים', score: { a: 6, b: 8 } },
]
