...
on soccerlite_test.tournaments
for all
to anon, authenticated
using (true)
with check (true);
...
comment on schema soccerlite_test is 'Soccer Lite test dataset — for e2e suites only';
